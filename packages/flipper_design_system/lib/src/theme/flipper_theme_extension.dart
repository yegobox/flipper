...
@immutable
class FlipperThemeExtension extends ThemeExtension<FlipperThemeExtension> {
  static FlipperThemeExtension of(BuildContext context) =>
      Theme.of(context).extension<FlipperThemeExtension>()!;

  static FlipperThemeExtension? maybeOf(BuildContext context) =>
      Theme.of(context).extension<FlipperThemeExtension>();

  const FlipperThemeExtension({
  ...
  factory FlipperThemeExtension.light() {
    ...
    return const FlipperThemeExtension(
      warning: FlipperColors.warning,
      success: FlipperColors.success,
      tint1: Color(0xFFE8E0FF),
      tint2: Color(0xFFFFE7FD),
      tint3: Color(0xFFFFE7EE),
      tint4: Color(0xFFFFEFE3),
      tint5: Color(0xFFFFF2CD),
      tint6: Color(0xFFF5FFDC),
      tint7: Color(0xFFDDFFD6),
      tint8: Color(0xFFDEFFF1),
      tint9: Color(0xFFE1FBFF),
      greyHover: Color(0xFFE0E0E0),
      greySelect: Color(0xFFF2FCFF),
      lightGreyHover: Color(0xFFE0F8FF),
      toggleOffFill: Color(0xFFE0E0E0),
      textColor: FlipperColors.onSurface,
      secondaryTextColor: Color(0xFF4F4F4F),
      strongText: Colors.black,
      calloutBGColor: Color(0xFFF2FCFF),
      tableCellBGColor: FlipperColors.surface,
      calendarWeekendBGColor: Color(0xFFFBFBFC),
      code: textStyle,
      callout: textStyle,
      caption: TextStyle(fontSize: 12, height: 1.5),
      progressBarBGColor: Color(0xFFE1FBFF),
      toggleButtonBGColor: Color(0xFFE0E0E0),
      gridRowCountColor: FlipperColors.onSurface,
      background: FlipperColors.surface,
      onBackground: FlipperColors.onSurface,
  ...
  factory FlipperThemeExtension.dark() {
    const textStyle = TextStyle(fontSize: 14, height: 1.5, color: Colors.white);
    return const FlipperThemeExtension(
      warning: FlipperColors.warning,
      success: FlipperColors.success,
      tint1: Color(0x4D9327FF),
      tint2: Color(0x66FC0088),
      tint3: Color(0x4DFC00E2),
      tint4: Color(0x80BE5B00),
      tint5: Color(0x33F8EE00),
      tint6: Color(0x4D6DC300),
      tint7: Color(0x5900BD2A),
      tint8: Color(0x80008890),
      tint9: Color(0x4D0029FF),
      greyHover: Color(0xFF363D49),
      greySelect: Color(0xFF1A202C),
      lightGreyHover: FlipperColors.primary,
      toggleOffFill: Color(0xFF828282),
      textColor: FlipperColors.onSurfaceDark,
      secondaryTextColor: FlipperColors.onSurfaceDark,
      strongText: Colors.white,
      calloutBGColor: Color(0xFF363D49),
      tableCellBGColor: Color(0xFF1A202C),
      calendarWeekendBGColor: Color(0xFF131720),
      code: textStyle,
      callout: textStyle,
      caption: TextStyle(fontSize: 12, height: 1.5, color: Colors.white70),
      progressBarBGColor: Color(0xFF363D49),
      toggleButtonBGColor: Color(0xFF828282),
      gridRowCountColor: FlipperColors.onSurfaceDark,
      background: FlipperColors.surfaceDark,
      onBackground: FlipperColors.onSurfaceDark,
  ...
  FlipperThemeExtension copyWith({
    ...
    Color? scrollbarHoverColor,
      ...
      FlipperThemeExtension(
        ...
        toggleButtonBGColor:
            toggleButtonBGColor ?? this.toggleButtonBGColor,
  ...
  @override
  ThemeExtension<FlipperThemeExtension> lerp(
    ThemeExtension<FlipperThemeExtension>? other,
    double t,
  ) {
    if (other is! FlipperThemeExtension) {
      return this;
    }
    return FlipperThemeExtension(
      ...
      code: TextStyle.lerp(code, other.code, t) ?? code,
      callout: TextStyle.lerp(callout, other.callout, t) ?? callout,
...
/// @deprecated Use [FlipperThemeExtension].
typedef AFThemeExtension = FlipperThemeExtension;
...
enum FlowyTint {
  ...
  Color color(BuildContext context) => switch (this) {
        FlowyTint.tint1 => FlipperThemeExtension.of(context).tint1,
        FlowyTint.tint2 => FlipperThemeExtension.of(context).tint2,
        FlowyTint.tint3 => FlipperThemeExtension.of(context).tint3,
        FlowyTint.tint4 => FlipperThemeExtension.of(context).tint4,
        FlowyTint.tint5 => FlipperThemeExtension.of(context).tint5,
        FlowyTint.tint6 => FlipperThemeExtension.of(context).tint6,
        FlowyTint.tint7 => FlipperThemeExtension.of(context).tint7,
        FlowyTint.tint8 => FlipperThemeExtension.of(context).tint8,
        FlowyTint.tint9 => FlipperThemeExtension.of(context).tint9,
      };
