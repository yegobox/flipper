...
String _$pendingTransactionHash() =>
    r'cfad33c0262467604188f3f60e2fd7807b93cc73';

/// See also [pendingTransaction].
@ProviderFor(pendingTransaction)
const pendingTransactionProvider = PendingTransactionFamily();

/// See also [pendingTransaction].
class PendingTransactionFamily extends Family<AsyncValue<ITransaction?>> {
  /// See also [pendingTransaction].
  const PendingTransactionFamily();

  /// See also [pendingTransaction].
  PendingTransactionProvider call({
    required bool isExpense,
  }) {
  ...
  @override
  PendingTransactionProvider getProviderOverride(
    covariant PendingTransactionProvider provider,
  ) {
    return call(
      isExpense: provider.isExpense,
    );
  ...
  @override
  String? get name => r'pendingTransactionProvider';
}

/// See also [pendingTransaction].
class PendingTransactionProvider
    extends AutoDisposeFutureProvider<ITransaction?> {
  /// See also [pendingTransaction].
  PendingTransactionProvider({
    required bool isExpense,
  }) : this._internal(
          (ref) => pendingTransaction(
            ref as PendingTransactionRef,
            isExpense: isExpense,
          ),
          ...
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$pendingTransactionHash,
          dependencies: PendingTransactionFamily._dependencies,
          allTransitiveDependencies:
              PendingTransactionFamily._allTransitiveDependencies,
          isExpense: isExpense,
        );

  PendingTransactionProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<ITransaction?> Function(PendingTransactionRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: PendingTransactionProvider._internal(
        (ref) => create(ref as PendingTransactionRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<ITransaction?> createElement() {
    return _PendingTransactionProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is PendingTransactionProvider && other.isExpense == isExpense;
  }
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin PendingTransactionRef on AutoDisposeFutureProviderRef<ITransaction?> {
  /// The parameter `isExpense` of this provider.
  bool get isExpense;
}

class _PendingTransactionProviderElement
    extends AutoDisposeFutureProviderElement<ITransaction?>
    with PendingTransactionRef {
  _PendingTransactionProviderElement(super.provider);

  @override
  bool get isExpense => (origin as PendingTransactionProvider).isExpense;
}
