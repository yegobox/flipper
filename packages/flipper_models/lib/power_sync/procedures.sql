...
BEGIN
  ...
  SELECT c.credits INTO current_credits FROM public.credits AS c WHERE c.branch_id = deduct_credits.branch_id FOR UPDATE;
  ...
  WHERE branch_id = deduct_credits.branch_id;
END;
$$;
