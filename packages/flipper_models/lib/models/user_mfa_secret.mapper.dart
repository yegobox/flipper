...
class UserMfaSecretMapper extends ClassMapperBase<UserMfaSecret> {
  ...
  static const Field<UserMfaSecret, String> _f$id = Field(
    'id',
    _$id,
    opt: true,
  );
  ...
  static const Field<UserMfaSecret, String> _f$secret = Field(
    'secret',
    _$secret,
  );
  static DateTime? _$createdAt(UserMfaSecret v) => v.createdAt;
  static const Field<UserMfaSecret, DateTime> _f$createdAt = Field(
    'createdAt',
    _$createdAt,
    key: r'created_at',
    opt: true,
  ...
  static const Field<UserMfaSecret, String> _f$issuer = Field(
    'issuer',
    _$issuer,
    opt: true,
  );
  static String? _$accountName(UserMfaSecret v) => v.accountName;
  static const Field<UserMfaSecret, String> _f$accountName = Field(
    'accountName',
    _$accountName,
    key: r'account_name',
    opt: true,
...
mixin UserMfaSecretMappable {
  String toJson() {
    return UserMfaSecretMapper.ensureInitialized().encodeJson<UserMfaSecret>(
      this as UserMfaSecret,
    );
  }

  Map<String, dynamic> toMap() {
    return UserMfaSecretMapper.ensureInitialized().encodeMap<UserMfaSecret>(
      this as UserMfaSecret,
    );
  }
  ...
  @override
  String toString() {
    return UserMfaSecretMapper.ensureInitialized().stringifyValue(
      this as UserMfaSecret,
    );
  }
  ...
  bool operator ==(Object other) {
    return UserMfaSecretMapper.ensureInitialized().equalsValue(
      this as UserMfaSecret,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return UserMfaSecretMapper.ensureInitialized().hashValue(
      this as UserMfaSecret,
    );
  }
}
