...
mixin CapellaFavoriteMixin implements FavoriteInterface {
  ...
  Future<List<Favorite>> getFavorites() async {
    throw UnimplementedError('getFavorites needs to be implemented for Capella');
  }

  @override
  Future<Favorite?> getFavoriteById({required String favId}) async {
    throw UnimplementedError('getFavoriteById needs to be implemented for Capella');
  }

  @override
  Future<Favorite?> getFavoriteByProdId({required String prodId}) async {
    throw UnimplementedError('getFavoriteByProdId needs to be implemented for Capella');
  }

  @override
  Future<Favorite?> getFavoriteByIndex({required String favIndex}) async {
    throw UnimplementedError('getFavoriteByIndex needs to be implemented for Capella');
  }

  @override
  Stream<Favorite?> getFavoriteByIndexStream({required String favIndex}) {
    throw UnimplementedError('getFavoriteByIndexStream needs to be implemented for Capella');
  }

  @override
  Future<int> deleteFavoriteByIndex({required String favIndex}) async {
    throw UnimplementedError('deleteFavoriteByIndex needs to be implemented for Capella');
  }
}
