...
class AgingRow {
  ...
  /// Canonical party id (transaction.customerId for AR, supplierId for AP).
  /// Debtors are keyed by this id when present; the free-text [name] is only
  /// a fallback for walk-in sales without a linked party record.
