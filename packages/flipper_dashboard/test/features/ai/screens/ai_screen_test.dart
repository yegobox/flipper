...
void main() {
  ...
  group('AiScreen Widget Tests', () {
    ...
    testWidgets(
      'creates new conversation and saves AI response when no conversation exists',
      (WidgetTester tester) async {
        ...
        when(
          () => mockDbSync.saveMessage(
            messageSource: 'ai',
            text:
                'I don\'t have enough data to analyze at the moment. Please make sure you have some sales or inventory data in your system.',
            phoneNumber: any(named: 'phoneNumber'),
            branchId: any(named: 'branchId'),
            role: 'assistant',
            conversationId: 'new_conversation_id',
        ...
        verify(
          () => mockDbSync.createConversation(title: 'Hello AI', branchId: "1"),
        ).called(1);
