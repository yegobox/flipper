...
void main() {
  ...
  //   test(
  //     'isFutureDateCompareTo should return true when current date is equal',
  //     () {
  //       final currentDate = DateTime.now();
  ...
  //   test(
  //     'isFutureDateCompareTo should return false when comparing with null',
  //     () {
  //       final currentDate = DateTime.now();
  ...
  //   expect(
  //     removeTrailingDash('2023-03-18T04:57:00.526Z-0001-1'),
  //     '2023-03-18T04:57:00.526Z-0001',
  //   );
  //   expect(
  //     removeTrailingDash('2023-03-18T04:57:00.526Z-0001-134'),
  //     '2023-03-18T04:57:00.526Z-0001',
  //   );
  //   expect(
  //     removeTrailingDash('2023-03-18T04:57:00.526Z-0001-299'),
  //     '2023-03-18T04:57:00.526Z-0001',
  //   );
  // });
