...
class BarSettleMobileScreen extends ConsumerStatefulWidget {
  const BarSettleMobileScreen({super.key});

  @override
  ConsumerState<BarSettleMobileScreen> createState() =>
      _BarSettleMobileScreenState();
}

class _BarSettleMobileScreenState extends ConsumerState<BarSettleMobileScreen> {
  String _method = 'Cash';
  double _tender = 0;
            ...
            if (_method == 'Cash') ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: BarTokens.blue, width: 1.5),
                ),
                child: Row(
            ...
            Material(
              ...
              child: InkWell(
                ...
                child: Ink(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(14),
                    gradient: buttonLooksEnabled ? BarTokens.gradBtn : null,
                    color: buttonLooksEnabled ? null : BarTokens.surface2,
...
class _SettleMobileTopBar extends StatelessWidget {
  const _SettleMobileTopBar({
...
class _BillSummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: BarTokens.surface,
        borderRadius: BorderRadius.circular(compact ? 18 : BarTokens.radiusLg),
        border: Border.all(color: BarTokens.line),
