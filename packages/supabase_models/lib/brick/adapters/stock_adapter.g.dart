...
Future<Stock> _$StockFromSupabase(
...
Future<Map<String, dynamic>> _$StockToSupabase(
  Stock instance, {
  required SupabaseProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
...
Future<Stock> _$StockFromSqlite(
  Map<String, dynamic> data, {
  ...
  return Stock(
    ...
    initialStock:
        data['initial_stock'] == null ? null : data['initial_stock'] as double?,
  )..primaryKey = data['_brick_id'] as int;
}

Future<Map<String, dynamic>> _$StockToSqlite(
  Stock instance, {
  required SqliteProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
