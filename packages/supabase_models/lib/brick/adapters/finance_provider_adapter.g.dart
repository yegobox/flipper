...
Future<FinanceProvider> _$FinanceProviderFromSupabase(Map<String, dynamic> data,
...
Future<FinanceProvider> _$FinanceProviderFromSqlite(Map<String, dynamic> data,
...
Future<Map<String, dynamic>> _$FinanceProviderToSqlite(FinanceProvider instance,
    {required SqliteProvider provider,
    OfflineFirstWithSupabaseRepository? repository}) async {
  return {
    'id': instance.id,
...
class FinanceProviderAdapter
  ...
  Future<int?> primaryKeyByUniqueColumns(
      FinanceProvider instance, DatabaseExecutor executor) async {
    final results = await executor.rawQuery('''
        SELECT * FROM `FinanceProvider` WHERE id = ? LIMIT 1''', [instance.id]);
  ...
  @override
  Future<FinanceProvider> fromSupabase(Map<String, dynamic> input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$FinanceProviderFromSupabase(input,
          provider: provider, repository: repository);
  @override
  Future<Map<String, dynamic>> toSupabase(FinanceProvider input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$FinanceProviderToSupabase(input,
          provider: provider, repository: repository);
  @override
  Future<FinanceProvider> fromSqlite(Map<String, dynamic> input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$FinanceProviderFromSqlite(input,
          provider: provider, repository: repository);
  @override
  Future<Map<String, dynamic>> toSqlite(FinanceProvider input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$FinanceProviderToSqlite(input,
          provider: provider, repository: repository);
}
