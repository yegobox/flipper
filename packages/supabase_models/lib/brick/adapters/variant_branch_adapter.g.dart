...
Future<VariantBranch> _$VariantBranchFromSupabase(
...
Future<Map<String, dynamic>> _$VariantBranchToSupabase(
  VariantBranch instance, {
  required SupabaseProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
  return {
...
Future<VariantBranch> _$VariantBranchFromSqlite(
  Map<String, dynamic> data, {
...
Future<Map<String, dynamic>> _$VariantBranchToSqlite(
  VariantBranch instance, {
  required SqliteProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
...
class VariantBranchAdapter
  ...
  Future<int?> primaryKeyByUniqueColumns(
    ...
    final results = await executor.rawQuery(
      '''
        SELECT * FROM `VariantBranch` WHERE id = ? LIMIT 1''',
      [instance.id],
    );
  ...
  @override
  Future<VariantBranch> fromSupabase(
