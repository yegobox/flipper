...
class VariantDittoAdapter extends DittoSyncAdapter<Variant> {
  ...
  Future<Map<String, dynamic>> toDittoDocument(Variant model) async {
    return {
      ...
      "isFuelManaged": model.isFuelManaged,
      "avgCost": model.avgCost,
      "avgCostSource": model.avgCostSource,
      "lastAvgCostReceiptRef": model.lastAvgCostReceiptRef,
      "rrp": model.rrp,
      "rrpEffectiveDt": model.rrpEffectiveDt?.toIso8601String(),
  ...
  Future<Variant?> fromDittoDocument(Map<String, dynamic> document) async {
    ...
    return Variant(
      ...
      isFuelManaged: document["isFuelManaged"],
      avgCost: document["avgCost"],
      avgCostSource: document["avgCostSource"],
      lastAvgCostReceiptRef: document["lastAvgCostReceiptRef"],
      rrp: document["rrp"],
      rrpEffectiveDt:
          DateTime.tryParse(document["rrpEffectiveDt"]?.toString() ?? ""),
