...
/// Subscription plan: **Supabase is the source of truth** — this type is **not** stored in
/// local Brick/SQLite. Writes use `Supabase.instance.client` (see [CoreSync]).
/// Offline reads use Ditto (backend [PlanSyncJob] / [PlanDittoSyncService]).
class Plan {
  final String? id;
  String? businessId;
  String? branchId;
  ...
  factory Plan.fromSupabaseJson(Map<String, dynamic> row) {
    ...
    return Plan(
      ...
      paymentCompletedByUser: row['payment_completed_by_user'] as bool? ?? false,
