...
const List<MigrationCommand> _migration_20250315043528_up = [
  ...
  InsertColumn('branch_id', Column.integer,
      onTable: 'BranchSmsConfig', unique: true),
  InsertColumn('sms_phone_number', Column.varchar, onTable: 'BranchSmsConfig'),
  InsertColumn('enable_order_notification', Column.boolean,
      onTable: 'BranchSmsConfig'),
  CreateIndex(columns: ['branch_id'], onTable: 'BranchSmsConfig', unique: true)
];

const List<MigrationCommand> _migration_20250315043528_down = [
...
@Migratable(
  version: '20250315043528',
  up: _migration_20250315043528_up,
  down: _migration_20250315043528_down,
)
class Migration20250315043528 extends Migration {
