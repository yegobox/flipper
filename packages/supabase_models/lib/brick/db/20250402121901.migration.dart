...
const List<MigrationCommand> _migration_20250402121901_up = [
  ...
  InsertColumn('updatable_stock_qty', Column.Double, onTable: 'Stock'),
...
const List<MigrationCommand> _migration_20250402121901_down = [
...
@Migratable(
  version: '20250402121901',
  up: _migration_20250402121901_up,
  down: _migration_20250402121901_down,
)
class Migration20250402121901 extends Migration {
