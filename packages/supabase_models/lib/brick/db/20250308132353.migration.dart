...
const List<MigrationCommand> _migration_20250308132353_up = [
  ...
  InsertColumn('current_sale_customer_phone_number', Column.varchar,
...
const List<MigrationCommand> _migration_20250308132353_down = [
...
@Migratable(
  version: '20250308132353',
  up: _migration_20250308132353_up,
  down: _migration_20250308132353_down,
)
class Migration20250308132353 extends Migration {
