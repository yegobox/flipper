...
const List<MigrationCommand> _migration_20250625131600_up = [
  ...
  InsertColumn('id', Column.varchar,
      onTable: 'ImportPurchaseDates', unique: true),
  InsertColumn('last_request_date', Column.varchar,
      onTable: 'ImportPurchaseDates'),
  ...
  InsertColumn('business_phone_number', Column.varchar,
      onTable: 'Conversation'),
  ...
  InsertForeignKey('_brick_ITransaction_items', 'ITransaction',
      foreignKeyColumn: 'l_ITransaction_brick_id',
      onDeleteCascade: true,
      onDeleteSetDefault: false),
  InsertForeignKey('_brick_ITransaction_items', 'TransactionItem',
  ...
  InsertColumn('original_transaction_id', Column.varchar,
      onTable: 'ITransaction'),
  InsertColumn('is_original_transaction', Column.boolean,
      onTable: 'ITransaction'),
  ...
  InsertColumn('id', Column.varchar,
      onTable: 'BranchPaymentIntegration', unique: true),
  InsertColumn('branch_id', Column.varchar,
      onTable: 'BranchPaymentIntegration'),
  InsertColumn('is_enabled', Column.boolean,
      onTable: 'BranchPaymentIntegration'),
  ...
  InsertForeignKey('TransactionItem', 'Stock',
  ...
  InsertColumn('destination_branch_id', Column.varchar,
  ...
  InsertColumn('id', Column.varchar,
      onTable: 'TransactionPaymentRecord', unique: true),
  InsertColumn('transaction_id', Column.varchar,
      onTable: 'TransactionPaymentRecord'),
  InsertColumn('amount', Column.Double, onTable: 'TransactionPaymentRecord'),
  InsertColumn('payment_method', Column.varchar,
      onTable: 'TransactionPaymentRecord'),
  ...
  InsertColumn('open_receipt_file_o_sale_complete', Column.boolean,
      onTable: 'Setting'),
  ...
  InsertColumn('is_last_subscription_payment_succeeded', Column.boolean,
      onTable: 'Business'),
  ...
  InsertForeignKey('_brick_Product_composites', 'Product',
      foreignKeyColumn: 'l_Product_brick_id',
      onDeleteCascade: true,
      onDeleteSetDefault: false),
  InsertForeignKey('_brick_Product_composites', 'Composite',
      foreignKeyColumn: 'f_Composite_brick_id',
      onDeleteCascade: true,
      onDeleteSetDefault: false),
  ...
  CreateIndex(
      ...
      onTable: '_brick_ITransaction_items',
      unique: true),
  ...
  CreateIndex(
      columns: ['id'], onTable: 'BranchPaymentIntegration', unique: true),
  CreateIndex(columns: ['id'], onTable: 'TransactionItem', unique: true),
  CreateIndex(
      columns: ['transaction_id'], onTable: 'TransactionItem', unique: false),
  CreateIndex(
      columns: ['variant_id'], onTable: 'TransactionItem', unique: false),
  ...
  CreateIndex(
      columns: ['id'], onTable: 'TransactionPaymentRecord', unique: true),
  ...
  CreateIndex(
      ...
      onTable: '_brick_Product_composites',
      unique: true),
...
const List<MigrationCommand> _migration_20250625131600_down = [
  ...
  DropIndex(
      'index__brick_ITransaction_items_on_l_ITransaction_brick_id_f_TransactionItem_brick_id'),
  ...
  DropIndex(
      'index__brick_Product_composites_on_l_Product_brick_id_f_Composite_brick_id'),
