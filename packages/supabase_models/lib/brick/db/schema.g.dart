...
final migrations = <Migration>{
  const Migration20260210125423(),const Migration20260131115249()};
  ...
  tables: <SchemaTable>{
    ...
    SchemaTable(
      ...
      columns: <SchemaColumn>{
        ...
        SchemaColumn('tenant_id', Column.varchar),
    ...
    SchemaTable(
      ...
      columns: <SchemaColumn>{
        ...
        SchemaColumn('identifier', Column.varchar),
    ...
    SchemaTable(
      ...
      columns: <SchemaColumn>{
        ...
        SchemaColumn('stock_remained_at_the_time_of_sale', Column.num),
    ...
    SchemaTable(
      ...
      columns: <SchemaColumn>{
        ...
        SchemaColumn('created_at', Column.datetime),
        SchemaColumn('updated_at', Column.datetime),
        SchemaColumn('branch_server_id', Column.varchar),
      },
      indices: <SchemaIndex>{
        SchemaIndex(columns: ['id'], unique: true),
      },
    ...
    SchemaTable(
      ...
      columns: <SchemaColumn>{
        ...
        SchemaColumn('pin', Column.integer),
        SchemaColumn('edit_id', Column.boolean),
        SchemaColumn('is_external', Column.boolean),
        SchemaColumn('ownership', Column.varchar),
        SchemaColumn('group_id', Column.integer),
        SchemaColumn('external', Column.boolean),
        SchemaColumn('updated_at', Column.datetime),
        SchemaColumn('deleted_at', Column.datetime),
        SchemaColumn('phone_number', Column.varchar),
      },
