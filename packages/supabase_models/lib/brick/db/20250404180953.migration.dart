...
const List<MigrationCommand> _migration_20250404180953_up = [
...
const List<MigrationCommand> _migration_20250404180953_down = [
  // DropColumn('provider_FinanceProvider_brick_id', onTable: 'Financing'),
  // DropColumn('inventory_request_InventoryRequest_brick_id', onTable: 'TransactionItem'),
  // DropColumn('stock_Stock_brick_id', onTable: 'Variant'),
  // DropColumn('branch_Branch_brick_id', onTable: 'InventoryRequest'),
...
@Migratable(
  version: '20250404180953',
  up: _migration_20250404180953_up,
  down: _migration_20250404180953_down,
)
class Migration20250404180953 extends Migration {
