...
const List<MigrationCommand> _migration_20250315044419_up = [
...
const List<MigrationCommand> _migration_20250315044419_down = [
  // DropColumn('provider_FinanceProvider_brick_id', onTable: 'Financing'),
  // DropColumn('inventory_request_InventoryRequest_brick_id', onTable: 'TransactionItem'),
  // DropColumn('stock_Stock_brick_id', onTable: 'Variant'),
  // DropColumn('branch_Branch_brick_id', onTable: 'InventoryRequest'),
...
@Migratable(
  version: '20250315044419',
  up: _migration_20250315044419_up,
  down: _migration_20250315044419_down,
)
class Migration20250315044419 extends Migration {
