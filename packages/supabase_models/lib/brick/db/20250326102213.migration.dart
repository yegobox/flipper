...
const List<MigrationCommand> _migration_20250326102213_up = [
...
const List<MigrationCommand> _migration_20250326102213_down = [
  // DropColumn('provider_FinanceProvider_brick_id', onTable: 'Financing'),
  // DropColumn('inventory_request_InventoryRequest_brick_id', onTable: 'TransactionItem'),
  // DropColumn('stock_Stock_brick_id', onTable: 'Variant'),
...
@Migratable(
  version: '20250326102213',
  up: _migration_20250326102213_up,
  down: _migration_20250326102213_down,
)
class Migration20250326102213 extends Migration {
