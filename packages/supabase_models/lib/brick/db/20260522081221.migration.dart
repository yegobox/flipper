...
const List<MigrationCommand> _migration_20260522081221_up = [
  ...
  InsertColumn('data_connector_url', Column.varchar, onTable: 'Ebm'),
...
const List<MigrationCommand> _migration_20260522081221_down = [
  ...
  DropColumn('data_connector_url', onTable: 'Ebm'),
...
@Migratable(
  version: '20260522081221',
  up: _migration_20260522081221_up,
  down: _migration_20260522081221_down,
)
class Migration20260522081221 extends Migration {
