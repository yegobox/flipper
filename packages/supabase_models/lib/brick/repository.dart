...
// import 'repository/connection_manager.dart';
...
//       final connectionManager = ConnectionManager(databaseFactoryToUse);
...
//         try {
//           // Try to open the database to check if it's valid using the connection manager
