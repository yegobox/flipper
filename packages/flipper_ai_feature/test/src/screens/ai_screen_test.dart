...
import 'package:flipper_ai_feature/src/screens/ai_screen.dart';
import 'package:flipper_ai_feature/src/widgets/ai_input_field.dart';
import 'package:flipper_ai_feature/src/widgets/welcome_view.dart';
// import 'package:flipper_ai_feature/test/helpers/mocks.dart';
// import 'package:flipper_ai_feature/test/helpers/setup.dart';
...
void main() {
  ...
  group('AiScreen Widget Tests', () {
    ...
    testWidgets('recording via pointer events', (WidgetTester tester) async {
      ...
      when(() => audioRecorder.dispose()).thenAnswer((_) async => null);
