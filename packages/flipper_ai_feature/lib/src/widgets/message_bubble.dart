                    ...
                    child: Stack(
                      ...
                      children: [
                        Stack(
                          ...
                          clipBehavior: Clip
                              .none, // Allow children to extend beyond boundaries
                          children: [
                            Container(
                              padding:
                                  EdgeInsets.all(hasVisualization ? 0 : 14),
                              decoration: BoxDecoration(
                                color: widget.isUser
                                    ? AiTheme.userMessageColor
                                    : (widget.message.messageSource ==
                                            'whatsapp'
                            ...
                            if (!widget.isUser &&
                              ...
                              Positioned(
                                ...
                                bottom: 0,
                                left:
                                    -3, // Position slightly to the left to account for the 3px bar
                                child: Container(
                                  width: 3,
                                  decoration: BoxDecoration(
